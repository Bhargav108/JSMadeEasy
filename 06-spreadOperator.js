...
function multiply(multiplier, ...theArgs) {
  // theArgs is considered an array
...
var welcomeMessage = "Spread operator is awsome";
var messageArray = [...welcomeMessage];
...
// Want to update building object

building = {...building, ...facilities};
console.log('Modified building -- ', building);
